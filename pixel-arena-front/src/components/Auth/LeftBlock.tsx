export default function LeftBlock() {
  return (
    <div id="left" className="w-1/2 h-screen rounded-r-2xl bg-primary flex justify-center items-center shadow-2xl text-secondary">
      <div id="title-container" className="flex flex-col justify-center items-center gap-1 cursor-pointer">
        <h1 className="text-6xl flex justify-center items-center gap-1 ">
          PixelArena <span className="material-symbols-outlined text-6xl font-medium">account_tree</span>
        </h1>
